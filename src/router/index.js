...
const routes = [
  ...
  { path: '/skills', name: 'Skills', component: () => import('../views/SkillsPage.vue'), meta: { requiresAuth: true } },
  { path: '/skills/:id', name: 'SkillDetail', component: () => import('../views/SkillDetail.vue'), meta: { requiresAuth: true } },
